...
parser.add_argument(
    "--rmaxcycles", default=8, type=int, help="limit max number of bisectional cycles"
)
parser.add_argument(
    "--model",
    dest="modelDir",
...
if args.ratio:
    ...
    if model.version >= 3.9:
        ...
        n = 2**args.exp
        for i in range(n - 1):
            img_list.append(model.inference(img0, img1, (i + 1) * 1.0 / n))
        img_list.append(img1)
    else:
        img_list = [img0, img1]
